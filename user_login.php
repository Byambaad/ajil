...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      $message[] = 'Нууц үг эсвэл нэр буруу байна!';
   }
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Нэвтрэх</h3>
      <input type="email" name="email" required placeholder="Емейл ээ оруулна уу" maxlength="50"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
